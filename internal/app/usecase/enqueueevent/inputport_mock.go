...
// Source: ./internal/app/usecase/enqueueevent/inputport.go
...
func (m *MockInputPort) EnqueueEvent(ctx context.Context, data InputData) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "EnqueueEvent", ctx, data)
}

// EnqueueEvent indicates an expected call of EnqueueEvent
func (mr *MockInputPortMockRecorder) EnqueueEvent(ctx, data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnqueueEvent", reflect.TypeOf((*MockInputPort)(nil).EnqueueEvent), ctx, data)
}
