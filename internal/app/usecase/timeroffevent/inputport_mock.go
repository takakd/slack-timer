...
// SetEventOff mocks base method
func (m *MockInputPort) SetEventOff(ac appcontext.AppContext, input InputData, presenter OutputPort) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetEventOff", ac, input, presenter)
}

// SetEventOff indicates an expected call of SetEventOff
func (mr *MockInputPortMockRecorder) SetEventOff(ac, input, presenter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetEventOff", reflect.TypeOf((*MockInputPort)(nil).SetEventOff), ac, input, presenter)
}
